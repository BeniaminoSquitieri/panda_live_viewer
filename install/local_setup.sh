...
_colcon_prefix_sh_COLCON_CURRENT_PREFIX="/home/bsquitieri-iit.local/panda_live_viewer/install"
...
if [ -n "$COLCON_PYTHON_EXECUTABLE" ]; then
  ...
  _colcon_python_executable="/home/bsquitieri-iit.local/miniforge3/envs/ros2_jazzy/bin/python3.12"
